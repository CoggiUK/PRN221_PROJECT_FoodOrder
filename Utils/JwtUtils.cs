...
namespace PRN221_PROJECT_FoodOrder.Utils
{
    ...
    {
        private static readonly string jwtSecretKey = "PRN221_QUICKFOODORDER";

        public static User DecodeJwt(string tokenString)
        {
        ...
        public static string GenerateToken(string userId, string email, int expirationMinutes = 10)
        {
            var tokenHandler = new JwtSecurityTokenHandler();
